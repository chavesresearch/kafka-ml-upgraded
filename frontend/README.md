...
React 19 + TypeScript + Vite + shadcn/ui. This is the deployed frontend —
a rewrite of a Vue 3 frontend (itself a rewrite of the original Angular 9
frontend), cut over into this directory 2026-08-04. Same screens, same
...
Because the contract is unchanged from the Vue/Angular images before it,
`kustomize/base/resources/frontend-deployment.yaml` needed zero changes
for this cutover — it already points at image name `kafka-ml-frontend`.
